...
const Home = () => {
  ...
  return (
    <div className="w-full bg-zinc-50 overflow-hidden font-sans text-zinc-900">
      ...
      <section
        ref={heroRef}
        className="relative min-h-[100vh] flex items-center pt-24 bg-zinc-950 overflow-hidden"
      >
        ...
        <div className="absolute inset-0 z-0 bg-zinc-950">
          <motion.div
            ...
            style={{
              backgroundImage:
                "radial-gradient(circle at center, rgba(37,99,235,0.2) 0%, transparent 60%)",
        ...
        <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
          <motion.div
            ...
            custom={1}
            animate="animate"
            className="absolute top-[20%] left-[10%] w-2 h-2 bg-blue-400 rounded-full shadow-[0_0_15px_rgba(96,165,250,0.8)]"
          />
          <motion.div
            variants={floatParticle}
            custom={1.5}
            animate="animate"
            className="absolute top-[60%] left-[5%] w-3 h-3 bg-primary rounded-full shadow-[0_0_20px_rgba(37,99,235,0.8)]"
          />
          <motion.div
            variants={floatParticle}
            custom={0.8}
            animate="animate"
            className="absolute top-[30%] right-[40%] w-1.5 h-1.5 bg-blue-300 rounded-full shadow-[0_0_10px_rgba(147,197,253,0.8)]"
          />
          <motion.div
            variants={floatParticle}
            custom={2}
            animate="animate"
            className="absolute bottom-[20%] right-[10%] w-2.5 h-2.5 bg-blue-500 rounded-full shadow-[0_0_20px_rgba(59,130,246,0.8)]"
          />
        </div>
        ...
        <div className="container mx-auto px-4 md:px-8 max-w-7xl relative z-10 grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="max-w-2xl py-12 lg:py-0">
            ...
            >
              ...
              Premium B2B Manufacturing & Exports
            </motion.div>
            ...
            >
              <Link
                to="/contact"
                className="relative group overflow-hidden bg-primary text-white px-8 py-4 rounded-full text-base font-bold transition-all hover:scale-105 hover:shadow-[0_0_30px_rgba(37,99,235,0.5)] flex items-center gap-2"
              >
              ...
              <Link
                to="/products"
                className="bg-transparent border border-zinc-700 text-white hover:border-zinc-500 hover:bg-zinc-800/50 px-8 py-4 rounded-full text-base font-bold transition-all flex items-center gap-2"
              >
                View Products
              </Link>
            </motion.div>
      ...
      <section className="py-32 bg-zinc-50 relative z-20 overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-8 max-w-7xl">
          <div className="text-center max-w-3xl mx-auto mb-20">
            <h2 className="text-4xl md:text-5xl font-black text-zinc-900 mb-6 tracking-tight uppercase">
              Core Capabilities
            </h2>
            <div className="w-24 h-1 bg-primary mx-auto mb-6"></div>
            <p className="text-lg text-zinc-500 font-medium">
              Precision engineered industrial solutions built for compliance,
              durability, and high-volume scalability.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "High-volume injection molding utilizing industrial-grade polymers for aerospace, automotive, and consumer sectors.",
                icon: Factory,
              },
              {
                title: "CNC Machining",
                desc: "5-axis CNC milling and precision turning delivering micro-tolerance geometries for critical components.",
                icon: Settings,
              },
              {
                title: "OEM / Custom Orders",
                desc: "Turnkey product development from CAD prototyping to contracted mass production and assembly.",
                icon: Wrench,
              },
            ].map((service, i) => (
              <TiltCard
              ...
              >
                ...
                <div className="relative z-20 flex flex-col h-full transform translate-z-[50px]">
                  ...
                  <p className="text-zinc-500 font-medium leading-relaxed leading-[1.8] flex-1">
                    {service.desc}
                  </p>
                </div>
              </TiltCard>
        ...
        <div className="container mx-auto px-4 md:px-8 max-w-7xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            >
              <motion.h2
                variants={fadeUp}
                className="text-4xl md:text-5xl font-black text-zinc-900 mb-8 tracking-tight uppercase"
              >
                The Industrial Standard
              </motion.h2>
              <motion.p
                variants={fadeUp}
                className="text-lg text-zinc-500 mb-12 font-medium leading-relaxed"
              >
                Operating at the intersection of rigorous ISO compliance and
                unprecedented manufacturing speed. Our infrastructure is heavily
                optimized for global enterprise supply chains.
              </motion.p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-6">
                {[
                  {
                    title: "Bulk Capacity",
                    desc: "Automated lines running 24/7.",
                  },
                  {
                    title: "Custom Mold Design",
                    desc: "In-house tooling engineering.",
                  },
                  {
                    title: "B2B Pricing",
                    desc: "Aggressive tiered cost reduction.",
                  },
                  {
                    title: "Fast Logistics",
                    desc: "Global fulfillment capabilities.",
                  },
                  {
                    title: "Export Ready",
                    desc: "Strict international compliance.",
                  },
                  {
                    title: "ISO Certified",
                    desc: "End-to-end quality control.",
                  },
                ].map((point, i) => (
                  <motion.div
                    key={i}
            ...
            >
              <div className="bg-zinc-200 rounded-3xl overflow-hidden shadow-2xl translate-y-8">
                <img
                  loading="lazy"
                  src="https://images.unsplash.com/photo-1565514020179-026b92b84bb6?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80"
                  alt="Factory Floor"
        ...
        <div className="container mx-auto px-4 md:px-8 max-w-7xl">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            <div className="max-w-2xl">
              ...
              <p className="text-lg text-zinc-400 font-medium">
                Engineered solutions meeting strict regulatory standards across
                core global sectors.
              </p>
            </div>
          </div>
          ...
          >
            {[
              {
                name: "Automotive",
                desc: "High-stress polymers & precise CNC.",
                icon: Car,
              },
              {
                name: "Electronics",
                desc: "Heat-resistant casings & micro-parts.",
                icon: Cpu,
              },
              {
                name: "Consumer Goods",
                desc: "High-volume structural plastics.",
                icon: ShoppingBag,
              },
              {
                name: "Industrial Equip.",
                desc: "Heavy-duty wear components.",
                icon: HardHat,
              },
            ].map((ind, i) => (
              <motion.div
              ...
              >
                ...
                <div className="relative z-10">
                  <ind.icon
                    size={48}
                    className="text-zinc-600 group-hover:text-primary transition-colors duration-500 mb-6 drop-shadow-[0_0_15px_rgba(37,99,235,0)] group-hover:drop-shadow-[0_0_15px_rgba(37,99,235,0.8)]"
                  />
        ...
        <div className="container mx-auto px-4 md:px-8 max-w-7xl">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6 border-b border-zinc-200 pb-8">
            <div className="max-w-3xl">
              <h2 className="text-4xl md:text-5xl font-black text-zinc-900 mb-4 tracking-tight uppercase">
                Industrial Catalog
              </h2>
              <p className="text-lg text-zinc-500 font-medium">
                Standardized components strictly manufactured for wholesale
                procurement.
              </p>
            </div>
            <Link
              to="/products"
              className="group flex items-center gap-2 text-zinc-900 font-bold uppercase tracking-wider hover:text-primary transition-colors"
            >
              Full Catalog{" "}
              <ArrowRight
                size={20}
          ...
          >
            {[
              {
                name: "Industrial Spool 500",
                desc: "Heavy-duty poly spool for industrial cabling.",
                img: "https://images.unsplash.com/photo-1544439169-dcbcfd70f20d?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
              },
              {
                name: "Precision Gear Set",
                desc: "CNC machined alloy gear components.",
                img: "https://images.unsplash.com/photo-1537462715879-360eeb61a0ad?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
              },
              {
                name: "Polymer Enclosures",
                desc: "IP68 rated structural plastic casework.",
                img: "https://images.unsplash.com/photo-1581092160562-40aa08e78837?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
              },
              {
                name: "Custom Fasteners",
                desc: "High-tensile non-corrosive fasteners.",
                img: "https://images.unsplash.com/photo-1587293852726-70cdb56c2866?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
              },
            ].map((prod, i) => (
              <motion.div
                key={i}
              ...
              >
                ...
                <div className="relative h-64 w-full overflow-hidden bg-zinc-200">
                  ...
                  <img
                    ...
                    src={prod.img}
                    alt={prod.name}
                    className="w-full h-full object-cover relative z-0 group-hover:scale-110 transition-transform duration-700 ease-out"
                  />
                  ...
                  <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-10 flex items-center justify-center backdrop-blur-sm">
                    <Link
                      to="/contact"
                      className="bg-primary text-white font-black uppercase tracking-wider py-4 px-8 rounded-full transform translate-y-4 group-hover:translate-y-0 active:scale-95 transition-all duration-300 shadow-[0_0_20px_rgba(37,99,235,0.5)] border border-primary/50 hover:bg-white hover:text-zinc-900 hover:border-white hover:shadow-[0_0_30px_rgba(255,255,255,0.5)]"
                    >
                      Request Quote
                    </Link>
                  </div>
                ...
                <div className="p-8 flex flex-col flex-1 relative z-20">
                  <h3 className="font-black text-zinc-900 text-xl mb-3">
                    {prod.name}
                  </h3>
      ...
      <section className="relative py-32 bg-zinc-950 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <motion.div
            ...
            style={{
              backgroundImage:
                "linear-gradient(-45deg, #09090b, #1e3a8a, #09090b, #1d4ed8)",
        ...
        <div className="container mx-auto px-4 md:px-8 max-w-4xl relative z-10 text-center">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-white mb-6 tracking-tight uppercase leading-tight">
              Scale Your Production Infrastructure
            </h2>
            <p className="text-lg md:text-xl text-zinc-400 mb-12 font-medium leading-relaxed max-w-2xl mx-auto">
              Initiate a custom OEM project or request high-volume standardized
              components immediately. Our engineers are ready.
            </p>
            <div className="flex flex-col sm:flex-row justify-center items-center gap-6">
              ...
              <div className="relative group w-full sm:w-auto">
                ...
                <Link
                  to="/contact"
                  className="relative w-full sm:w-auto bg-zinc-950 hover:bg-zinc-900 border border-zinc-800 text-white px-10 py-5 rounded-full text-lg font-black uppercase tracking-wider transition-all hover:scale-105 active:scale-95 flex items-center justify-center gap-3"
                >
                  Contact Sales HQ{" "}
                  <ArrowRight
                    size={22}
