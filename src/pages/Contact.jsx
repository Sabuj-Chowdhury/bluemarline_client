      ...
      <section className="py-24 bg-zinc-50 border-b border-zinc-200">
        <div className="container mx-auto px-4 md:px-8 max-w-7xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            >
              <motion.h2 variants={fadeUp} className="text-3xl md:text-4xl font-black text-zinc-900 mb-8 tracking-tight">Global Headquarters</motion.h2>
              ...
              <div className="space-y-8 mb-12">
                <motion.div variants={slideInLeft} className="flex items-start gap-5 group">
                  ...
                  <div>
                    <h4 className="font-black text-zinc-900 text-lg mb-1">Factory Location</h4>
                    <p className="text-zinc-500 font-medium leading-relaxed">123 Industrial Area, Phase 1<br/>Standard Factory Zone, Dhaka 1200.</p>
                  </div>
                </motion.div>
                ...
                <motion.div variants={slideInLeft} className="flex items-start gap-5 group">
                  ...
                  <div>
                    <h4 className="font-black text-zinc-900 text-lg mb-1">Direct Line</h4>
                    <p className="text-zinc-500 font-medium leading-relaxed">+880 1234 567 890</p>
                  </div>
                </motion.div>
                ...
                <motion.div variants={slideInLeft} className="flex items-start gap-5 group">
                  ...
                  <div>
                    <h4 className="font-black text-zinc-900 text-lg mb-1">Sales Inquiry</h4>
                    <p className="text-zinc-500 font-medium leading-relaxed">sales@bluemarlinbd.com</p>
                  </div>
                </motion.div>
              </div>

              {/* Map Placeholder */}
              <motion.div variants={fadeUp} className="w-full h-[300px] bg-zinc-200 rounded-3xl overflow-hidden shadow-inner relative group border border-zinc-300">
                <img 
                  loading="lazy" 
            ...
            >
              <div className="bg-white p-10 md:p-12 rounded-3xl shadow-2xl border border-zinc-100 relative overflow-hidden">
                ...
                <h3 className="text-2xl font-black text-zinc-900 mb-2 relative z-10">Request a Quote</h3>
                <p className="text-zinc-500 mb-8 font-medium text-sm relative z-10">Provide your specifications for rapid B2B pricing.</p>

                <form className="space-y-6 relative z-10">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <label className="block text-xs font-bold text-zinc-900 uppercase tracking-wider mb-2">Full Name</label>
                      <input type="text" className="w-full bg-zinc-50 border border-zinc-200 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all font-medium" placeholder="John Doe" />
                    </div>
                    <div>
                      <label className="block text-xs font-bold text-zinc-900 uppercase tracking-wider mb-2">Email Address</label>
                      <input type="email" className="w-full bg-zinc-50 border border-zinc-200 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all font-medium" placeholder="john@company.com" />
                    </div>
                  </div>
                  
                  <div>
                    <label className="block text-xs font-bold text-zinc-900 uppercase tracking-wider mb-2">Company Name</label>
                    <input type="text" className="w-full bg-zinc-50 border border-zinc-200 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all font-medium" placeholder="Enterprise LLC" />
                  </div>

                  <div>
                    <label className="block text-xs font-bold text-zinc-900 uppercase tracking-wider mb-2">Service Interest</label>
                  ...
                  <div>
                    <label className="block text-xs font-bold text-zinc-900 uppercase tracking-wider mb-2">Project Details</label>
                    <textarea rows="4" className="w-full bg-zinc-50 border border-zinc-200 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all font-medium resize-none" placeholder="Provide volume, material preferences, and timeline..."></textarea>
                  </div>

                  <button type="button" className="w-full bg-primary hover:bg-blue-700 text-white font-bold py-4 rounded-xl shadow-[0_0_20px_rgba(37,99,235,0.3)] hover:shadow-[0_0_30px_rgba(37,99,235,0.5)] transition-all flex items-center justify-center gap-2 group">
              ...
              <div className="mt-8 bg-zinc-900 rounded-2xl p-6 flex items-center justify-between border border-zinc-800 shadow-xl overflow-hidden relative group">
                ...
                <div className="relative z-10 flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-zinc-400 text-sm font-medium">Chat with our engineering team directly.</p>
                  </div>
                </div>
